...
export class ProjectService{
    ...
    public getNTopRatedLeanProjects({
        ...
        const numberOfProjects = Math.max(0, Math.min(_numberOfProjects, leanProjects.length));

        const descendingOrder = (a: LeanProject, b: LeanProject): number => b.rating - a.rating;
